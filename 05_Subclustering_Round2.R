...
Round2 <- subset(Round0, idents = c("Doublet.01" , "Doublet.02",  "Doublet.03","Doublet.04" ,"Doublet.05","Doublet.06"), invert=TRUE)
rm(Round0)
...
new.cluster.ids <- c("NK_cell"   ,    "CD161_T_cell" , "CD8_T_cell" ,   "CD4_T_cell"  ,  "Treg"    ,   "Treg"    ,
                     ...
                     "S.Corneum",  "S.Corneum",  "S.Corneum",  "S.Corneum" , "S.Granulosum" , "S.Spinosum"  ,  "S.Basale"  , "S.Basale" ,  "ECM"   )
...
marker <- c("HLA-DRB5" , "HLA-DRA" ,  "HLA-DPB1" , "CD86"   , "LAMP3"   ,  "LY75"   ,   "CD40"   ,   "CIITA" ,      "CD80"   ,   "CD274"   ,  "PDCD1LG2" ,
            "KYNU"   ,   "IDO1"    , "CD14"   ,   "AIF1"    , "IL10", "CD1C"   ,  "CD209"  ,  
               "THBD"  ,  "ITGAM" ,  "LILRB1"  ,    "LILRB2" ,   "LILRB4","FCGR3A"  ,  "CD163"     )
...
marker <- c("CD3D" ,   "CD4"   ,  "KLRB1"  ,  "GNLY"  ,"PRF1"  ,   "CD8A"   , "CD8B"  ,
...
pdf("IL17A_FOXP3_FeaturePlot_Tregs.pdf", width=12,height=2)
p <- FeaturePlot(object = Treg, features = c("IL17A", "FOXP3"), blend = TRUE, label=FALSE, order=TRUE, max.cutoff = "q70") 
print(p)
dev.off()

pdf("IL17F_FOXP3_FeaturePlot_Tregs.pdf", width=12,height=2)
p <- FeaturePlot(object = Treg, features = c("IL17F", "FOXP3"), blend = TRUE, label=FALSE, order=TRUE, max.cutoff = "q70") 
print(p)
dev.off()
