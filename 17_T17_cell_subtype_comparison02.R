...
Tcells <- subset(Round2, idents = c( "CD8_T_cell_Psoriasis"   , "CD4_T_cell_Psoriasis"))
IL17A.Tcells <- subset(Tcells, subset = IL17A > 1)
IL17A.Tcells <- subset(IL17A.Tcells, subset = IL17F < 1)
levels(IL17A.Tcells)
new.cluster.ids <- c("IL17A.CD4_Tcells","IL17A.CD8_Tcells")
...
levels(IL17F.Tcells)
new.cluster.ids <- c("IL17F.CD4_Tcells")
...
new.cluster.ids <- c("IL17AF.CD4_Tcells")
...
new.cluster.ids <- c("CD4_Tcells","CD8_Tcells","CD4_Tcells","CD4_Tcells" )
...
Idents(object = T17_cells) <- factor(Idents(object = T17_cells), 
                                                       levels = (c( "CD8_Tcells","CD4_Tcells")))
#####################################################################
...
pdf("Heatmap_gene_expression_T17_cells_sAverage_expression10.pdf", width=6,height=10)
...
DEG <- FindMarkers(T17_cells, ident.1 =  "CD8_T_cell" , ident.2 ="CD4_T_cell", logfc.threshold = 0.1,min.pct =0 )
...
pdf("Volcanoplot_T17_cell.pdf", width=14,height=10)
