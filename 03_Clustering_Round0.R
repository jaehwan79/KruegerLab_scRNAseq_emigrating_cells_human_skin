...
########################################################################
# (Supplementary Figure S7b) Dot plot with labels ####
Idents(object = Round0) <- ("integrated_snn_res.0.8")
DefaultAssay(Round0) <- "RNA"
...
new.cluster.ids <- c(
  "S.Corneum.01","Treg.01","Mature_DC.01","S.Corneum.02","CD4_T_cell","S.Corneum.03","S.Basale.01","S.Corneum.04","S.Spinosum","CD8_T_cell","Semimature_DC","Doublet.01","S.Corneum.05","S.Granulosum","Melanocyte","Doublet.02","Treg.02","CD161_T_cell","NK_cell","Doublet.03","Mature_DC.03","Mature_DC.02","S.Basale.02","Doublet.04","Macrophage","Doublet.05","Doublet.06","Doublet.07"
          )	
...
Idents(object = Round0) <- factor(Idents(object = Round0), 
                                  levels = (c(
                                    "NK_cell","CD161_T_cell","CD8_T_cell","CD4_T_cell","Treg.01","Treg.02","Mature_DC.01","Mature_DC.02","Mature_DC.03","Semimature_DC","Macrophage","Melanocyte","S.Corneum.01","S.Corneum.02","S.Corneum.03","S.Corneum.04","S.Corneum.05","S.Granulosum","S.Spinosum","S.Basale.01","S.Basale.02","Doublet.01","Doublet.02","Doublet.03","Doublet.04","Doublet.05","Doublet.06","Doublet.07"
                                                                          )))
...
########################################################################
# (Supplementary Figure S7a) Visualization with label ####
DefaultAssay(Round0) <- "RNA"
