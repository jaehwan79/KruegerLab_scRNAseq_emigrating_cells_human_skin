...
load("/Users/jkim05/Dropbox/10X_JKIM/aggregation/KruegerLab_github/Round0_integrated.Rda")
######################################################################################################
...
new.cluster.ids <- c(
  "S.Corneum.01","Treg.01","Mature_DC.01","CD4_T_cell.01","S.Corneum.02","S.Corneum.03","S.Corneum.04","S.Basale.01","S.Spinosum","CD4_T_cell.02","Semimature_DC","S.Corneum.05","S.Granulosum","Melanocyte","Treg.02","CD8_T_cell","ECM","CD161_T_cell","NK_cell","S.Corneum.06","Mature_DC.02","Mature_DC.03","S.Basale.02","Mature_DC.04","Mature_DC.05","Macrophage"
      )	
...
Idents(object = Round0) <- factor(Idents(object = Round0), 
                                  levels = (c(
                                    "NK_cell","CD161_T_cell","CD8_T_cell","CD4_T_cell.01","CD4_T_cell.02","Treg.01","Treg.02","Mature_DC.01","Mature_DC.02","Mature_DC.03","Mature_DC.04","Mature_DC.05","Semimature_DC","Macrophage","Melanocyte","S.Corneum.01","S.Corneum.02","S.Corneum.03","S.Corneum.04","S.Corneum.05","S.Corneum.06","S.Granulosum","S.Spinosum","S.Basale.01","S.Basale.02","ECM"
                                                                                                  )))
Round0[["ClusterNames_0.8"]] <- Idents(object = Round0)
Idents(object = Round0) <- fct_rev(Idents(object = Round0))

pdf('Dot plot_Roun0.pdf', width=15,height=9)
